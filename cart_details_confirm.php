<?php
	...
	if(isset($_SESSION['user'])){
		...
		try{
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td>".$row['name']."</td>
						<td>".$row['price']."</td>
						<td><input type='text' class='form-control' id='quantity' name='quantity' value='".$row['quantity']."' readonly></td>
						<td>".$subtotal."</td>
					</tr>
				";
			}
			...
			$output .= "<tr>
						...
						<td colspan='4'><textarea class='form-control' id='delivery_address' name='delivery_address' readonly>".$user['address']."</textarea><td>
					</tr>";
	...
	else
	{
		if(count($_SESSION['cart']) != 0)
		{
			...
			$output .= "<tr>
						<td colspan='2'><b>Delivery Address</b></td>
						<td colspan='4'><textarea class='form-control' id='delivery_address' name='delivery_address'></textarea><td>
					</tr>";
		}
